...
const FloatingInput = ({ 
  label, type, name, value, onChange, icon: Icon, required = false 
}: any) => {
  ...
  return (
    <div className="relative group">
      ...
      <input 
        ...
        className="w-full bg-white border-2 border-gray-100 rounded-xl pl-11 pr-4 pt-6 pb-2 text-sm outline-none focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all text-gray-900 font-semibold"
      />
    </div>
  );
};
