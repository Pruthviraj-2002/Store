                ...
                <div className="flex-1 px-4 py-6 sm:px-8 space-y-8">
                  ...
                  <div className="pt-4 flex gap-4">
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer"
                      className="flex-1 bg-blue-600 text-white font-bold text-center py-3 rounded-xl hover:bg-blue-700 transition-colors shadow-sm flex justify-center items-center gap-2"
                    >
